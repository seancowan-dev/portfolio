...
const AboutBarker = observer((props) => {
    return (
<div className="about-barker-container">
        <div className="about-barker-text" contenteditable>
            ...
            I've got a condition about coding scripts, I'm quite fond of libraries and widgets. Pardon my presumption but you'll want me to code you some higher order functions. If intereactivity is what you seek then React will make things really neat.  Add to that a responsive design and soon your site will really shine!  
